...
<!-- NAVBAR ENDS -->
 ...
 <header class="second-section flex-grow-1 d-flex flex-column justify-content-center mb-5">
    ...
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
      ...
      <i class="fa-solid fa-microchip"></i><use xlink:href="#toggles2"/></svg>
        ...
        <section class="filosofia d-flex"> <!-- seccion filosofia -->
        ...
        <section class="cita container py-5 pt-0 mt-0"> <!-- seccion citas-->
